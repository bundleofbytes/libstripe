...
pub struct Subscription {
    ...
    // pub collection_method: String? // poorely documented... (TODO)
    pub created: i64,
...
pub struct SubscriptionParam<'a> {
    ...
    // #[serde(skip_serializing_if = "Option::is_none")]
    // collection_method: Option<String>? // poorely documented... (TODO)
    #[serde(skip_serializing_if = "Option::is_none")]
...
#[derive(Default, Serialize, Debug, PartialEq)]
pub struct SubscriptionCancelParam {
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl Subscription {
    pub fn create<'a>(client: &Client, param: SubscriptionParam<'a>) -> crate::Result<Self> {
    ...
    pub fn update<'a>(client: &Client, id: &str, param: SubscriptionParam<'a>) -> crate::Result<Self> {
        client.post(UrlPath::Subscriptions, vec![id], param)
    }

    pub fn cancel(client: &Client, id: &str, param: SubscriptionCancelParam) -> crate::Result<Self> {
        client.delete(UrlPath::Subscriptions, vec![id], param)
    }

    pub fn list(client: &Client, param: SubscriptionListParam) -> crate::Result<List<Self>> {
